...
Repositorio para scripts de estadística aplicada a ciencias biológicas y agronómicas.

## Estructura

- `datos/`: datos crudos, procesados y metadatos.
- `01_Exploracion_Supuestos/`: normalidad, homocedasticidad y diagnóstico visual de modelos.
